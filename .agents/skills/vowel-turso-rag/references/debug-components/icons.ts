/**
 * @module rag-debug/icons
 * 
 * SVG icons used by the RAG debug tool UI.
 * 
...
export const ICONS = {
  ...
  documents: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/></svg>`,
  ...
  /** Refresh/reload icon (FaRedo) */
  refresh: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.3 8.59c.17.48.27 1 .27 1.54 0 2.88-2.46 5.22-5.5 5.22h-.93l1.23 1.23c.24.24.24.63 0 .87-.24.24-.64.24-.88 0l-2.38-2.38c-.24-.24-.24-.63 0-.87l2.38-2.38c.24-.24.64-.24.88 0 .24.24.24.63 0 .87l-1.23 1.23h.93c2.35 0 4.25-1.71 4.25-3.83 0-1.2-.59-2.27-1.52-3.02-.25-.21-.28-.58-.07-.83.21-.25.58-.28.83-.07.97.75 1.6 1.83 1.83 3.02zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18.5c-4.69 0-8.5-3.81-8.5-8.5S7.31 3.5 12 3.5s8.5 3.81 8.5 8.5-3.81 8.5-8.5 8.5z"/></svg>`,
